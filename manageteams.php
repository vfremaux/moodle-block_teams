...
foreach ($teams as $t) {
    ...
    $othermembers = '';
    if ($members = groups_get_members($t->groupid,  'u.id,u.username,u.firstname,u.lastname,u.email')) {
        $others = array();
...
if ($unteamedgroups) {
    ...
    foreach ($unteamedgroups as $g) {
        if ($members = groups_get_members($g->id,  'u.id,u.username,u.firstname,u.lastname,u.email')) {
            $others = array();
            foreach ($members as $m) {
