...
$string['configteammaxsize'] = 'Set a limit size for a team (applicable to all site). 0 stands for no limit.';
...
$string['errorcreategroup'] = 'could not insert record into groups table';
...
$string['teammaxsize'] = 'Team max size';
