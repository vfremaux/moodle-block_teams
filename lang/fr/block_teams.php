...
$string['alreadyinagroup'] = 'Vous êtes déjà dans un groupe dans ce cours';
$string['alreadyinvited'] = 'Cet utilisateur est déjà invité à rejoindre un groupe';
$string['alreadyinvitedtogroup'] = 'Cet utilisateur est déjà invité à rejoindre ce groupe';
...
$string['errordeleteleader'] = 'Vous êtes leader de ce groupe. Vous ne pouvez pas vous retirer de ce groupe avant d\'avoir transmis votre leadership à quelqu\'un d\'autre !';
...
$string['groupfull'] = 'Le nombre maximum d\'utilisateurs par groupe a été atteint. Vous ne pouvez plus inviter d\'autres utilisateurs.';
$string['groupinvites'] = 'Invitations au groupe';
$string['groupinvitesdesc'] = 'Vous avez été invité dans les groupes suivants';
...
$string['groupmessagesent'] = 'Message envoyé au groupe';
...
$string['inviteaccepted'] = 'Vous avez été ajouté(e) au groupe';
$string['inviteauser'] = 'Inviter un utilisateur';
$string['invited'] = 'Invité';
$string['invitedeclined'] = 'Vous avez décliné cette invitation';
$string['invitedeleted'] = 'Participations au groupe supprimées';
$string['inviteemailsubject'] = 'Invitation à un groupe dans un cours';
...
$string['memberdeleted'] = 'L\'utilisateur a été retiré du groupe';
$string['message'] = 'Message';
$string['messagegroup'] = 'Envoyer un message à tous les membres du groupe';
...
{$a->fromuser} vous invite à créer un compte sur le site "{$a->sitename}"

{$a->custommsg}

Pour confirmer la création de votre compte, allez à l\'adresse :

{$a->link}

Dans la plupart des logiciels de courriel, ce lien doit apparaître en bleu
et vous pouvez directement cliquer dessus. Si ça ne marche pas,
copiez/collez l\'adresse dans un navigateur.

Pour plus d\'aide, contactez l\'administrateur du site,
{$a->admin}
';
...
* Privé forcé : Les équipes créées seront et resteront systématiquement privées. Si cette option est choisie en cours d\'exploitation, alors toutes les équipes déjà créées deviennent privées.
* Public forcé : Les équipes créées seront et resteront systématiquement publiques. Si cette option est choisie en cours d\'exploitation, alors toutes les équipes déjà créées deviennent publiques.
';
